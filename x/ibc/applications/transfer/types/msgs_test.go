...
var (
	...
	invalidIBCCoin   = sdk.NewCoin("ibc/07F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", sdk.NewInt(100))
	validNonIBCCoin  = sdk.NewCoin("notibc/7F1D3FCF4AE79E1554D670D1AD949A9BA4E4A3C76C63093E17E446A46061A7A2", sdk.NewInt(100))
...
func TestMsgTransferValidation(t *testing.T) {
	testCases := []struct {
		...
		{"valid non-ibc denom", NewMsgTransfer(validPort, validChannel, validNonIBCCoin, addr1, addr2, timeoutHeight, 0), true},
