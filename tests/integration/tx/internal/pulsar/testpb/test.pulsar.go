...
var (
	md_WithAddress       protoreflect.MessageDescriptor
	fd_WithAddress_owner protoreflect.FieldDescriptor
)

func init() {
	file_testpb_test_proto_init()
	md_WithAddress = File_testpb_test_proto.Messages().ByName("WithAddress")
	fd_WithAddress_owner = md_WithAddress.Fields().ByName("owner")
}

var _ protoreflect.Message = (*fastReflection_WithAddress)(nil)

type fastReflection_WithAddress WithAddress

func (x *WithAddress) ProtoReflect() protoreflect.Message {
	return (*fastReflection_WithAddress)(x)
}

func (x *WithAddress) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_WithAddress_messageType fastReflection_WithAddress_messageType
var _ protoreflect.MessageType = fastReflection_WithAddress_messageType{}

type fastReflection_WithAddress_messageType struct{}

func (x fastReflection_WithAddress_messageType) Zero() protoreflect.Message {
	return (*fastReflection_WithAddress)(nil)
}
func (x fastReflection_WithAddress_messageType) New() protoreflect.Message {
	return new(fastReflection_WithAddress)
}
func (x fastReflection_WithAddress_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_WithAddress
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_WithAddress) Descriptor() protoreflect.MessageDescriptor {
	return md_WithAddress
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_WithAddress) Type() protoreflect.MessageType {
	return _fastReflection_WithAddress_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_WithAddress) New() protoreflect.Message {
	return new(fastReflection_WithAddress)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_WithAddress) Interface() protoreflect.ProtoMessage {
	return (*WithAddress)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_WithAddress) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Owner) != 0 {
		value := protoreflect.ValueOfBytes(x.Owner)
		if !f(fd_WithAddress_owner, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_WithAddress) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "testpb.WithAddress.owner":
		return len(x.Owner) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: testpb.WithAddress"))
		}
		panic(fmt.Errorf("message testpb.WithAddress does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WithAddress) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "testpb.WithAddress.owner":
		x.Owner = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_WithAddress) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "testpb.WithAddress.owner":
		value := x.Owner
		return protoreflect.ValueOfBytes(value)
	default:
		...
		panic(fmt.Errorf("message testpb.WithAddress does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WithAddress) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "testpb.WithAddress.owner":
		x.Owner = value.Bytes()
	default:
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WithAddress) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "testpb.WithAddress.owner":
		panic(fmt.Errorf("field owner of message testpb.WithAddress is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: testpb.WithAddress"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_WithAddress) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "testpb.WithAddress.owner":
		return protoreflect.ValueOfBytes(nil)
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_WithAddress) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in testpb.WithAddress", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_WithAddress) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_WithAddress) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_WithAddress) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_WithAddress) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*WithAddress)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: WithAddress: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: WithAddress: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
...
func (x *WithAddress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WithAddress) ProtoMessage() {}

// Deprecated: Use WithAddress.ProtoReflect.Descriptor instead.
func (*WithAddress) Descriptor() ([]byte, []int) {
	return file_testpb_test_proto_rawDescGZIP(), []int{5}
}

func (x *WithAddress) GetOwner() []byte {
	if x != nil {
		return x.Owner
	}
	return nil
...
var file_testpb_test_proto_rawDesc = []byte{
	...
	0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0xa4, 0x01, 0x0a, 0x0b, 0x57, 0x69, 0x74, 0x68, 0x41, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x78, 0x0a, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0c, 0x42, 0x62, 0xea, 0xde, 0x1f, 0x05, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0xf2,
	0xde, 0x1f, 0x0c, 0x79, 0x61, 0x6d, 0x6c, 0x3a, 0x22, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x22, 0xfa,
	...
	,
	...
	0x61, 0x6d, 0x69, 0x6e, 0x6f, 0x6a, 0x73, 0x6f, 0x6e, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e,
	0x61, 0x6c, 0x2f, 0x74, 0x65, 0x73, 0x74, 0x70, 0x62, 0x2f, 0x70, 0x75, 0x6c, 0x73, 0x61, 0x72,
...
var file_testpb_test_proto_goTypes = []interface{}{
	...
	(*WithAddress)(nil),        // 5: testpb.WithAddress
}
