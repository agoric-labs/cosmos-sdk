...
func (m *WithAddress) Reset()         { *m = WithAddress{} }
func (m *WithAddress) String() string { return proto.CompactTextString(m) }
func (*WithAddress) ProtoMessage()    {}
func (*WithAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_41c67e33ca9d1f26, []int{5}
}
func (m *WithAddress) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *WithAddress) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WithAddress.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *WithAddress) XXX_Merge(src proto.Message) {
	xxx_messageInfo_WithAddress.Merge(m, src)
}
func (m *WithAddress) XXX_Size() int {
	return m.Size()
}
func (m *WithAddress) XXX_DiscardUnknown() {
	xxx_messageInfo_WithAddress.DiscardUnknown(m)
}

var xxx_messageInfo_WithAddress proto.InternalMessageInfo

func (m *WithAddress) GetOwner() github_com_cosmos_cosmos_sdk_types.AccAddress {
	if m != nil {
		return m.Owner
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*WithAddress)(nil), "testpb.WithAddress")
}
...
var fileDescriptor_41c67e33ca9d1f26 = []byte{
	...
	,
}
...
func (m *WithAddress) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *WithAddress) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *WithAddress) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *WithAddress) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WithAddress: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WithAddress: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
